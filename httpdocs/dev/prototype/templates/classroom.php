<?php include("../patterns/partials/header.html"); ?>
        ...
        <?php include("../patterns/partials/interior-hero-slot-class.html"); ?>
        ...
        <section class="section-body-button panel-primary">
            <a class="button button-primary" href="process.php">Learn More About Glyphix</a>
        </section>
        ...
        <section class="section-body-button panel-primary">
            <a class="button button-primary" href="process.php">Learn More About Responsive Web Design</a>
        </section>
